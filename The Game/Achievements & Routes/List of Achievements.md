The following article is a list of achievements in Scotch Mist. As usual, this page is filled with unmarked spoilers for mechanics, characters, and stories. Proceed with caution.
#Tier-2 #General 
# General
These achievements can be achieved by any character, but might require some setup.
#### Time-based
...
| Icon | Name                 | Description                            | Requirements                               |
| ---- | -------------------- | -------------------------------------- | ------------------------------------------ |
|      | For King and Country | We shall never surrender...            | Complete the ending "For King and Country" |
|      | Sunset               | Do not go gentle into that good night. | Complete the ending "Sunset"               |
